...
public interface AdvancedListSelectionModel<E> extends ListSelectionModel {
    ...
    /**
     * Set the DefaultEventSelectionModel as editable or not. This means that the user cannot
    ...
    /**
     * Returns whether the DefaultEventSelectionModel is editable or not.
     */
    boolean getEnabled();
