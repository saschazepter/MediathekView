...
public class LuceneDirectoryModePanel extends JPanel {
    ...
    private final JComboBox<String> modeComboBox = new JComboBox<>(new String[]{"auto", "mmap", "niofs"});
    ...
    public void setSelectedMode(String mode) {
        ...
        var isKnown = Arrays.asList(new String[]{"auto", "mmap", "niofs"}).contains(normalizedMode);
