...
public class ApplicationConfiguration {
    ...
    public static final String APPLICATION_AUDIOTHEK_PODCASTINDEX_API_KEY = "application.audiothek.podcastindex.api_key";
    public static final String APPLICATION_AUDIOTHEK_PODCASTINDEX_API_SECRET = "application.audiothek.podcastindex.api_secret";
