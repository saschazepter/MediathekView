...
abstract class AbstractEventList<E> protected constructor(
    ...
    @Suppress("CAST_NEVER_SUCCEEDS")
    override fun listIterator(index: Int): @NonNull MutableListIterator<E> = EventListIterator(this, index) as MutableListIterator<E>

    override fun subList(fromIndex: Int, toIndex: Int): @NonNull MutableList<E> = SubEventList(this, fromIndex, toIndex, true)
