...
class SortedList<E>(
    ...
    open var comparator: @Nullable Comparator<in E>? = null
        set(value) {
            field = value
            val previousSorted = sorted
    ...
    override fun listChanged(listChanges: ListEvent<E>) {
        ...
        while (listChanges.next()) {
            ...
            when (listChanges.type) {
                ...
                ListEvent.UPDATE -> {
                    val unsortedNode = unsortedTree.get(unsortedIndex)
    ...
    open override fun getSourceIndex(mutationIndex: Int): Int {
        val sortedNode = sorted!!.get(mutationIndex)
    ...
    open override fun contains(element: E): Boolean = indexOf(element) != -1
    ...
    open override fun iterator(): @NonNull MutableIterator<E> = SortedListIterator()
