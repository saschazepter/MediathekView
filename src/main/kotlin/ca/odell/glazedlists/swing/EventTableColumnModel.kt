            ...
            for (candidate in source) {
                ...
                if (column == null) {
                    throw IllegalStateException(
                        "null TableColumn objects are not allowed in EventTableColumnModel",
                    )
                }
            }
