...
interface TableModelEventAdapter<E> : ListEventListener<E> {
    ...
    fun interface Factory<E> : Function<AbstractTableModel, TableModelEventAdapter<E>> {
        fun create(tableModel: AbstractTableModel): TableModelEventAdapter<E>

        override fun apply(tableModel: AbstractTableModel): TableModelEventAdapter<E> = create(tableModel)
    }
}
