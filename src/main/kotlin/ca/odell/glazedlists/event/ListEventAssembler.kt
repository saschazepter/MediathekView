...
class ListEventAssembler<E>(
    ...
    @JvmField
    protected var eventLevel: Int = 0

    /** whether to allow nested events */
    @JvmField
    protected var allowNestedEvents: Boolean = true

    /** the current reordering array if this change is a reorder */
    @JvmField
    protected var reorderMap: IntArray? = null
    ...
    fun forwardEvent(listChanges: ListEvent<*>) {
        ...
        if (changesToCopy != null) {
            while (changesToCopy.next()) {
                val type = changesToCopy.type
                val index = changesToCopy.index
                val oldValue = changesToCopy.oldValue as E
                val newValue = changesToCopy.newValue as E
    ...
    @JvmSynthetic
    fun getListDeltas(): Tree4Deltas<E> = listDeltas

    @JvmSynthetic
    fun getListBlocksLinear(): BlockSequence<E> = blockSequence

    @JvmSynthetic
    fun getReorderMap(): IntArray? = reorderMap
...
@get:JvmSynthetic
internal val <E> ListEventAssembler<E>.isEventInProgress: Boolean
    get() = isEventInProgress()

@get:JvmSynthetic
internal val <E> ListEventAssembler<E>.isEventEmpty: Boolean
    get() = isEventEmpty()

@get:JvmSynthetic
internal val <E> ListEventAssembler<E>.useListBlocksLinear: Boolean
    get() = getUseListBlocksLinear()

@get:JvmSynthetic
internal val <E> ListEventAssembler<E>.listDeltas: Tree4Deltas<E>
    get() = getListDeltas()

@get:JvmSynthetic
internal val <E> ListEventAssembler<E>.listBlocksLinear: BlockSequence<E>
    get() = getListBlocksLinear()

@get:JvmSynthetic
internal val <E> ListEventAssembler<E>.reorderMap: IntArray?
    get() = getReorderMap()
