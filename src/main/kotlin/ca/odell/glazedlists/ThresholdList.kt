...
class ThresholdList<E> private constructor(
    ...
    open val evaluator: Evaluator<E> = evaluator
    ...
    open fun setLowerThreshold(element: E) {
        lowerThreshold = evaluator.evaluate(element)
    }

    open fun setUpperThreshold(element: E) {
    ...
    fun interface Evaluator<E> : ToIntFunction<E> {
        fun evaluate(element: E): Int

        override fun applyAsInt(value: E): Int = evaluate(value)
    }
