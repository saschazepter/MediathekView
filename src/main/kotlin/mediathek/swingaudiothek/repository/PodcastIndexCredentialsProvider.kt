...
class PodcastIndexCredentialsProvider {
    ...
    fun read(): PodcastIndexCredentials? {
        val key = systemProperty(PRIMARY_KEY_PROPERTY)
            ?: systemProperty(LEGACY_KEY_PROPERTY)
        val secret = systemProperty(PRIMARY_SECRET_PROPERTY)
            ?: systemProperty(LEGACY_SECRET_PROPERTY)
    ...
    companion object {
        ...
        private const val LEGACY_KEY_PROPERTY = "mediathek.audiothek.podcastindex.apiKey"
        private const val LEGACY_SECRET_PROPERTY = "mediathek.audiothek.podcastindex.apiSecret"
