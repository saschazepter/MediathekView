...
class DatenFilm private constructor(
    ...
    val sha256: String
        get() {
            ...
            val hash = if (USE_WINDOWS_SHA256_FAST_PATH) {
                WindowsSha256FastPath.hash(this)
            } else {
                getSha256Legacy()
            }
            sha256Cache = hash
    ...
    private fun getSha256Legacy(): String {
    ...
    private object WindowsSha256FastPath {
    ...
    companion object {
        ...
        private val USE_WINDOWS_SHA256_FAST_PATH = SystemUtils.IS_OS_WINDOWS
