...
internal class AbstractEventListBehaviorTest {
    @Test
    fun reflectionSurfaceRetainsItsJavaShapeAndInterfaceDefaults() {
        val type = AbstractEventList::class.java

        assertTrue(Modifier.isPublic(type.modifiers))
        assertTrue(Modifier.isAbstract(type.modifiers))
        assertEquals("ca.odell.glazedlists.EventList<E>", type.genericInterfaces.single().typeName)
        assertEquals(listOf("E"), type.typeParameters.map { it.typeName })

        assertEquals(
            setOf(
                FieldShape(
                    "updates",
                    "ca.odell.glazedlists.event.ListEventAssembler",
                    "ca.odell.glazedlists.event.ListEventAssembler<E>",
                    setOf("protected"),
                ),
                FieldShape(
                    "readWriteLockBacking",
            ...
            type.declaredFields.mapTo(linkedSetOf(), ::fieldShape),
        )
        ...
        assertEquals(
            setOf(
                ConstructorShape(
                    emptyList(),
                    emptyList(),
                    flagsOf(type.getDeclaredConstructor().modifiers),
                ),
                ConstructorShape(
                    listOf("ca.odell.glazedlists.event.ListEventPublisher"),
                    listOf("ca.odell.glazedlists.event.ListEventPublisher"),
                    flagsOf(type.getDeclaredConstructor(ListEventPublisher::class.java).modifiers),
                ),
            ),
            type.declaredConstructors.mapTo(linkedSetOf(), ::constructorShape),
        )

        val requiredMethods =
            setOf(
                MethodShape("getPublisher", emptyList(), "ca.odell.glazedlists.event.ListEventPublisher", "ca.odell.glazedlists.event.ListEventPublisher", setOf("public")),
                MethodShape("getReadWriteLock", emptyList(), "java.util.concurrent.locks.ReadWriteLock", "java.util.concurrent.locks.ReadWriteLock", setOf("public")),
                MethodShape("addListEventListener", listOf("ca.odell.glazedlists.event.ListEventListener"), "void", "void", setOf("public")),
                MethodShape("removeListEventListener", listOf("ca.odell.glazedlists.event.ListEventListener"), "void", "void", setOf("public")),
                MethodShape("size", emptyList(), "int", "int", setOf("public", "abstract")),
                MethodShape("isEmpty", emptyList(), "boolean", "boolean", setOf("public")),
                MethodShape("contains", listOf("java.lang.Object"), "boolean", "boolean", setOf("public")),
                MethodShape("iterator", emptyList(), "java.util.Iterator", "java.util.Iterator<E>", setOf("public")),
                MethodShape("toArray", emptyList(), "java.lang.Object[]", "java.lang.Object[]", setOf("public")),
                MethodShape("toArray", listOf("java.lang.Object[]"), "java.lang.Object[]", "T[]", setOf("public")),
                MethodShape("add", listOf("java.lang.Object"), "boolean", "boolean", setOf("public")),
                MethodShape("remove", listOf("java.lang.Object"), "boolean", "boolean", setOf("public")),
                MethodShape("containsAll", listOf("java.util.Collection"), "boolean", "boolean", setOf("public")),
                MethodShape("addAll", listOf("java.util.Collection"), "boolean", "boolean", setOf("public")),
                MethodShape("addAll", listOf("int", "java.util.Collection"), "boolean", "boolean", setOf("public")),
                MethodShape("removeAll", listOf("java.util.Collection"), "boolean", "boolean", setOf("public")),
                MethodShape("retainAll", listOf("java.util.Collection"), "boolean", "boolean", setOf("public")),
                MethodShape("clear", emptyList(), "void", "void", setOf("public")),
                MethodShape("removeIf", listOf("java.util.function.Predicate"), "boolean", "boolean", setOf("public")),
                MethodShape("replaceAll", listOf("java.util.function.UnaryOperator"), "void", "void", setOf("public")),
                MethodShape("equals", listOf("java.lang.Object"), "boolean", "boolean", setOf("public")),
                MethodShape("hashCode", emptyList(), "int", "int", setOf("public")),
                MethodShape("get", listOf("int"), "java.lang.Object", "E", setOf("public", "abstract")),
                MethodShape("set", listOf("int", "java.lang.Object"), "java.lang.Object", "E", setOf("public")),
                MethodShape("add", listOf("int", "java.lang.Object"), "void", "void", setOf("public")),
                MethodShape("remove", listOf("int"), "java.lang.Object", "E", setOf("public")),
                MethodShape("indexOf", listOf("java.lang.Object"), "int", "int", setOf("public")),
                MethodShape("lastIndexOf", listOf("java.lang.Object"), "int", "int", setOf("public")),
                MethodShape("listIterator", emptyList(), "java.util.ListIterator", "java.util.ListIterator<E>", setOf("public")),
                MethodShape("listIterator", listOf("int"), "java.util.ListIterator", "java.util.ListIterator<E>", setOf("public")),
                MethodShape("subList", listOf("int", "int"), "java.util.List", "java.util.List<E>", setOf("public")),
                MethodShape("toString", emptyList(), "java.lang.String", "java.lang.String", setOf("public")),
                MethodShape("close", emptyList(), "void", "void", setOf("public")),
            )

        val actualDeclaredMethods =
            type.declaredMethods
                .filterNot(Method::isSynthetic)
                .mapTo(linkedSetOf(), ::methodShape)

        assertEquals(
            requiredMethods,
            actualDeclaredMethods.intersect(requiredMethods),
        )

        assertEquals(
            setOf(
                MethodShape("removeAll" + '$' + "lambda" + '$' + "0", listOf("kotlin.jvm.functions.Function1", "java.lang.Object"), "boolean", "boolean", setOf("private", "final", "static")),
                MethodShape("retainAll" + '$' + "lambda" + '$' + "0", listOf("java.util.Collection", "java.lang.Object"), "boolean", "boolean", setOf("private", "final", "static")),
                MethodShape("clear" + '$' + "lambda" + '$' + "0", listOf("java.lang.Object"), "boolean", "boolean", setOf("private", "final", "static")),
            ),
            actualDeclaredMethods - requiredMethods,
        )
        ...
        val closeMethod = type.getMethod("close")
        assertEquals(type, closeMethod.declaringClass)
        assertFalse(closeMethod.isDefault)

        val disposeMethod = type.getMethod("dispose")
        assertEquals(EventList::class.java, disposeMethod.declaringClass)
        assertTrue(Modifier.isAbstract(disposeMethod.modifiers))

        listOf(
            type.getMethod("iterator"),
            type.getMethod("listIterator"),
            type.getMethod("listIterator", Int::class.javaPrimitiveType),
            type.getMethod("subList", Int::class.javaPrimitiveType, Int::class.javaPrimitiveType),
        ).forEach { method ->
            assertTrue(method.annotatedReturnType.isAnnotationPresent(NonNull::class.java), method.toString())
        }

        listOf(
            type.getMethod("addAll", Collection::class.java) to 0,
            type.getMethod("addAll", Int::class.javaPrimitiveType, Collection::class.java) to 1,
            type.getMethod("removeAll", Collection::class.java) to 0,
            type.getMethod("retainAll", Collection::class.java) to 0,
            type.getMethod("removeIf", Predicate::class.java) to 0,
            type.getMethod("replaceAll", UnaryOperator::class.java) to 0,
        ).forEach { (method, parameterIndex) ->
            assertTrue(
                method.annotatedParameterTypes[parameterIndex].isAnnotationPresent(NonNull::class.java),
                method.toString(),
            )
        }
    }
    ...
    private fun fieldShape(field: Field) =
        FieldShape(field.name, field.type.typeName, field.genericType.typeName, flagsOf(field.modifiers))

    private fun constructorShape(constructor: Constructor<*>) =
        ConstructorShape(
            constructor.parameterTypes.map(Class<*>::getTypeName),
            constructor.genericParameterTypes.map { it.typeName },
            flagsOf(constructor.modifiers),
        )

    private fun methodShape(method: Method) =
        MethodShape(
            method.name,
            method.parameterTypes.map(Class<*>::getTypeName),
            method.returnType.typeName,
            method.genericReturnType.typeName,
            flagsOf(method.modifiers),
        )

    private fun flagsOf(modifiers: Int): Set<String> =
        buildSet {
    ...
    private data class ConstructorShape(
        ...
        val genericParameterTypes: List<String>,
        val flags: Set<String>,
    )
